/*  src/components/Voting/VotingPage.jsx
    – เพิ่ม “กดแล้วยุบเล็กน้อย” ให้ปุ่ม ลงคะแนนเสียง
*/
      ...
      <div className="relative w-full max-w-sm mx-auto">
        ...
        >
          ...
          <div className="p-6 space-y-5">
            ...
            {/* submit – added press animation classes */}
            <button
              type="submit"
              disabled={!choice || !isOpen}
              className="w-full py-4 px-6 bg-primary text-white font-semibold rounded-lg
                         hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed
                         transition-all duration-200 active:scale-95 active:shadow-inner"  /* press effect[1] */
            >
              {isOpen
                ? (choice ? "ลงคะแนนเสียง" : "กรุณาเลือกการลงคะแนน")
                : "ปิดรับคะแนน"}
            </button>
          </div>
        </form>
